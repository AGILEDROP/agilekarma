...
const KarmaFeed = (props: KarmaFeedInterface) => {
    ...
    <>
      ...
      {fromUsers === undefined ? (
        ...
        <div className="container">
          {fromUsers === undefined || (fromUsers as []).length === 0 ? (
            <div className="row mt-5">
